...
const translations = {
  bg: {
    ...
    'payment.eyebrow': 'Плащане', 'payment.heading': 'Плати сигурно', 'payment.accent': 'с PayPal.', 'payment.p1': 'За продукти с валидна EUR цена можеш да преминеш към PayPal от кошницата. При продукти с цена при запитване първо получаваш потвърдена сума.', 'payment.p2': 'Плащането се обработва от PayPal за KOLMAN EOOD', 'payment.status': 'Добави платими продукти в кошницата, за да активираш PayPal checkout.',
