...
assert.match(index, /paypal-static-paypal/);
assert.match(index, /paypal-static-card/);
assert.match(index, /https:\/\/www\.paypal\.com\/ncp\/payment\/653GFDV8Z76G2/);
assert.match(index, /Дебитна \/ кредитна карта/);
...
assert.match(payment, /https:\/\/www\.paypal\.com\/ncp\/payment\/653GFDV8Z76G2/);
assert.match(payment, /paypal-static-fallback/);
assert.match(payment, /Дебитна \/ кредитна карта/);
