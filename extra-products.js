export const EXTRA_PRODUCTS = [
  {
    id: 'prospray-339-connect-emulsion',
    category: 'airless',
    name: 'WAGNER ProSpray 3.39 Connect Emulsion',
    model: 'ProSpray 3.39 Connect Emulsion',
    eyebrow: 'WAGNER PROFESSIONAL · CONNECT · AIRLESS',
    blurb: 'Флагманска бутална airless система за големи строителни обекти, емулсии и професионални приложения с IntelliSync.',
    priceKnown: true,
    price: 7899,
    priceCurrency: 'EUR',
    priceType: 'market-reference',
    priceNote: 'Актуална публична референтна цена; крайната цена, наличност и комплектация се потвърждават преди покупка.',
    priceSource: 'OnlineMashini.bg',
