...
export const ROBOT_PRODUCTS = [
  {
    ...
    priceNote: 'Цена по оферта от производителя. Публична фиксирана цена не е обявена.', priceSource: 'Partner Robotics',
  ...
  },
  {
    ...
    priceKnown: false, price: null, priceCurrency: 'USD', priceType: 'quote',
    priceNote: 'Цена по оферта от производителя.', priceSource: 'Fangshi Robotics',
  ...
  },
  {
    ...
    priceKnown: false, price: null, priceCurrency: 'USD', priceType: 'quote',
    priceNote: 'Цена по оферта; необходима е проверка на конкретната конфигурация.', priceSource: 'Fangshi Robotics',
  ...
  },
  {
    ...
    priceKnown: false, price: null, priceCurrency: 'USD', priceType: 'quote',
    priceNote: 'Цена по запитване. Производителят публикува технически параметри, но не и фиксирана публична цена.', priceSource: 'Nanjing Zhuling Technology',
  ...
  },
  {
    ...
    priceKnown: false, price: null, priceCurrency: 'USD', priceType: 'quote',
    priceNote: 'Цена по оферта от производителя.', priceSource: 'Guangdong Bright Dream Robotics',
  ...
  },
  {
    ...
    priceKnown: false, price: null, priceCurrency: 'USD', priceType: 'quote',
    priceNote: 'Цена по оферта. Конкретната конфигурация и транспортните условия се уточняват с производителя.', priceSource: 'Smart Build Robotics',
  ...
  },
  {
    ...
    priceKnown: false, price: null, priceCurrency: 'USD', priceType: 'quote',
    priceNote: 'Цена и точна конфигурация по запитване.', priceSource: 'Derutu',
